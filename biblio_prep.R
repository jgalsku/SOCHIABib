...
biblio <-
  ...
  mutate_at("pub_type", str_replace, "journalArticle", "Artículo revista científica") %>% 
  ...
  mutate_at("pub_type", str_replace, "webpage", "Artículo prensa")

biblio <-
  biblio %>%
  mutate_at("met", str_replace, "Morfometría", "Antropometría")
